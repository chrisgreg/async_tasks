defmodule AsyncTasksWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AsyncTasksWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AsyncTasksWeb.Gettext, "errors", msg, opts)
    end
  end
